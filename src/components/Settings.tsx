import { Wallet, Trash2, Twitter, LogOut, Loader2, ExternalLink } from 'lucide-react';
...
export function Settings() {
  ...
  const [activeSection, setActiveSection] = useState<'wallet' | 'x-account' | 'danger'>('wallet');
        ...
        <div className="flex gap-8">
          ...
          <div className="w-48 shrink-0">
            <nav className="space-y-1">
              ...
              <button
                onClick={() => setActiveSection('x-account')}
                className={`w-full flex items-center gap-2 px-4 py-3 rounded-lg text-left transition-all ${
                  activeSection === 'x-account'
                    ? 'bg-white/10 text-white'
                    : 'text-white/60 hover:text-white hover:bg-white/5'
                }`}
              >
            ...
            {activeSection === 'x-account' && (
              <div className="rounded-2xl border border-white/10 backdrop-blur-sm p-8">
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <h3 className="text-2xl">X Account</h3>
                </div>
